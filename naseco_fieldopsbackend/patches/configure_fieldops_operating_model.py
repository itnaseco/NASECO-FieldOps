...
ROLE_PERMISSIONS = {
	...
	OUTGROWER_MANAGER_ROLE: {
		...
		"Region": "rwcd",
		"Location": "rwcd",
		"Season Production Plan": "rwcsxd",
		"Outgrower": "rwcd",
		"Farm Plot": "rwcd",
		"Crop Cycle": "rwcd",
		"Outgrower Production Contract": "rwcsd",
		"Stage Activity": "rwcd",
		"Agronomy Report": "rwcd",
		"Inspection": "r",
		"Field Corrective Action": "r",
		"Stage Input Request": "rwcd",
		"Stage Input Dispatch": "r",
		"Crop Cycle Advance Request": "rwcd",
		"Crop Cycle Settlement": "rwcd",
		"Crop Production Lot": "rwcd",
