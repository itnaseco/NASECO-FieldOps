...
permission_query_conditions = {
	...
	"Field Visit": "naseco_fieldopsbackend.permissions.field_visit_query",
	"Stage Input Dispatch": "naseco_fieldopsbackend.permissions.stage_input_dispatch_query",
...
has_permission = {
	...
	"Field Visit": "naseco_fieldopsbackend.permissions.has_permission",
	"Stage Input Dispatch": "naseco_fieldopsbackend.permissions.has_permission",
