...
def _contract(supplier):
	...
	doc = frappe.get_doc({
		...
		"expected_harvest_date": "2026-11-30", "contracted_area_acres": 1,
		"contracted_area_hectares": 0.40468564224,
		...
		"required_isolation_quality": "Good", "is_signed": 1, "signed_on": "2026-07-15 10:00:00",
...
def _lot(cycle):
	...
	return frappe.get_doc({"doctype": "Crop Production Lot", "lot_number": 1, "crop_cycle": cycle.name,
		"planting_start_date": "2026-07-25", "planting_end_date": "2026-07-26", "area_acres": 1,
		"accepted_area_acres": 0.95, "rejected_area_acres": 0.05, "parent_seed_qty": 20,
